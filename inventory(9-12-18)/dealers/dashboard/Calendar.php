...
document.getElementById("sideblock-header-content").innerHTML =d.getDate()+"<br>"+ months[d.getMonth()];
   ...
   var calendar = $('#calendar').fullCalendar({
    ...
    var usercal = $('#calendar').fullCalendar('getCalendar');
        usercal.on('select', function(clickedDate, jsEvent, view){
       ...
       
     {
      ...
      success:function()
      {
       ...
       $("#setEventModal1").modal('hide');
        $("#sideblock-content").load("Calerdar2/update-sideblock.php");
      }
    });
    });
 ...
 <body >
  ...
  <div class="container" style="padding-top: 132px;width:100%">
    <div class="row" style="padding-left:20px">
      
<div class="col-lg-4 col-sm-12 col-xs-12" id="sideblock" style="padding:0px;">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        <div id="sideblock-header" class="bg-overlay bg-overlay--blue"></div>
                                        <h3>
                                            <i id="sideblock-header-content" class="zmdi zmdi-account-calendar"></i></h3>
                                    ...
                                    <div class="au-task js-list-load">
                                        ...
                                        <div class="au-task-list js-scrollbar3" id="sideblock-content">
                                            <?php include_once("Calendar2/update-sideblock.php") ?>
                                        </div>
   ...
   <div id="calendar" class="col-md-8 col-sm-12 col-xs-12"></div>
                <!--  modal    ------------------------------------------------------------------------------------------------->
