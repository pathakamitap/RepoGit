            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="Calendar.php">
                                <i class="ti-calendar"></i>Calendar</a>
                        </li>
                        <li>
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active">
                            <a class="js-arrow" href="index.php">
                               ...
                               <i id="sidebaricon" class="c-blue-500 ti-home"></i><span id="sidebarcontent1">Dashboard</span>
                                
                            </a>
                        </li>
                        <li>
                            <a href="Calendar.php">
                                <i id="sidebaricon" class="ti-calendar"></i><span id="sidebarcontent1">Calendar</span></a>
                        </li>
                        <li>
                            <a href="Edit-Delete_a_Vehicle.php">
                    ...
                    <ul class="list-unstyled navbar__list">
                        <li class="active">
                            <a class="js-arrow" href="index.php">
                                ...
                                <i id="sidebaricon" class="ti-home"></i><span id="sidebarcontent">Dashboard</span>
                                
                            </a>
                        </li>
                        <li>
                            <a href="Calendar.php">
                                <i id="sidebaricon" class="ti-calendar"></i><span id="sidebarcontent">Calendar Schedule</span></a>
                        </li>
                        <li>
                            <a href="Edit-Delete_a_Vehicle.php">
...
unset($_SESSION['updateProfile']);
    $id=$_SESSION['dealerid'];
    $con = mysqli_connect("localhost","root","","inventry");
    $qry1=mysqli_query($con,"SELECT dealerdata.*,dealersaccount.profilePic FROM `dealersaccount`,`dealerdata` where dealerdata.id='$id' and dealersaccount.id='$id'");
    while($data=mysqli_fetch_assoc($qry1)){
        $dealershipname=$data['DealershipName'];
        $image=$data['Image'];
