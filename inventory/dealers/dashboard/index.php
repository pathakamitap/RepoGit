...
if(!isset($_SESSION['dealerid'])) {
    ...
    <div class="page-wrapper" >
        <!-- HEADER MOBILE-->
        <header class="header-mobile d-block d-lg-none" id="headerfortoggle">
...
$("#toggle-icon").click(function(e){
    e.preventDefault();
    if($i%2==0){
        //$("#sidebartoggle").animate({with: '62px'});
        $("#page-container").animate({width: '95.39%'});
        $(".header-desktop").animate({left: '61px'});
        $("#sidebartoggle").toggleClass("is-collapse");
        $("#sidebartoggle").animate({width:"62px"});
        $(".logo").animate({width:"62px"});
        
        $i++;
        $i=$i%2;
    }else{
         //$("#sidebartoggle").animate({with: '250px'});
         $("#page-container").animate({width: '81.45%'});
         $(".header-desktop").animate({left: '249px'});
         $("#sidebartoggle").toggleClass("is-collapse");
        $("#sidebartoggle").animate({width:"250px"});
        $(".logo").animate({width:"250px"});
