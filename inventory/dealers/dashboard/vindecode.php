            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="Edit-Delete_a_Vehicle.php">
                                <i id="sidebaricon" class="c-purple ti-pencil"></i><span id="sidebarcontent">Edit/Delete a Vehicle</span></a>
                        </li>
                        <li>
                            <a href="Vehicle_with_pending_Info.php">
                                <i id="sidebaricon" class="c-brown ti-palette"></i><span id="sidebarcontent">Vehicle with pending Info</span></a>
                        </li>
                      
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i id="sidebaricon" class="c-teal ti-car"></i><span id="sidebarcontent">Add a vehicle</span></a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
        ...
        <div class="page-container" id="page-container" style="position: absolute;right:0px;">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <?php     }else{ ?>
                                                 <i id="fa-user-out" class="far fa-user"></i>
                                        <?php     }     ?>
            ...
            <div class="main-content">
                    ...
                    <div class="container-fluid" style="padding:0px;margin:0px">
                        ...
                        <div id="contentbox" style="width: 93%;height:600px;border:1px #efefef groove">
                            <p> i am vin decode.
