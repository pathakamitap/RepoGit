...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="container">
      <form action="authenticate.php" method="post" onsubmit="return validatepass()">
...
?>
        ...
        <div class="col-lg-6">
            <button type="submit" class="btn btn-default" name="changePasswordSubmit">Submit</button>
        </div>
       
      </form>
      <form action="login.php" method="post">
       <div class="col-lg-6">
            <button type="submit" class="btn btn-default" name="cancelChangePassword">Cancel</button>
        </div>
    </form>
<script>
function check1(str) {
